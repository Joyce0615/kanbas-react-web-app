  ...
  return (
    <div id="wd-forms">
      ...
      <form id="wd-text-fields">
        ...
        <input id="wd-text-fields-username" placeholder="e.g., joyce" /> <br />
        ...
        <input
          ...
          value="Weekend" 
          title="The last name"
          // if both have placeholder and value, only show value
        />
        <br />
        <br />
        <h5>Text boxes</h5>
        ...
        <br />
        <br />
        <textarea id="wd-textarea" cols={35} rows={15}>
        ...
        <button
          id="wd-all-good"
          onClick={() => alert("Today is a wonderful day!")}
          type="button"
        >
          Hello World!
        </button>
        ...
        <h4 id="wd-dropdowns">Dropdowns (Select one)</h4>
        ...
        <input
          ...
          min="50000"
          max="1000000"
          //   value="100000" this is a fixed value
        />
        <br />
        ...
        <input
          ...
          // placeholder="Doe" This is useless
          max="5"
          //   value="4"
        />
        <br />
