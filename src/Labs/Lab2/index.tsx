  ...
  return (
    <div className="container">
      ...
      <div id="wd-css-colors">
        <h2>Colors</h2>
        <h3 className="wd-fg-color-blue"></h3>
        <p className="wd-fg-color-red">
          The text in this paragraph is red but
          <span className="wd-fg-color-green"> this text is green</span>
        </p>
      </div>
      <div id="wd-css-backgroud-colors">
        <h3 className="wd-bg-color-blue wd-fg-color-white"> Background color</h3>
        <p className="wd-bg-color-red wd-fg-color-black">
          This background of this paragraph is red but
          <span className="wd-bg-color-green wd-fg-color-white">
            the backgound of this text is green and the foreground white
          </span>
        </p>
      </div>
      ...
      <div id="wd-css-dimensions">
        ...
        <div className="wd-dimension-landscape wd-bg-color-blue wd-fg-color-white">
          Landscape
        </div><div className="wd-dimension-square wd-bg-color-red">
          Square
        </div>
      </div>
      ...
      <div id="wd-bs-responsive-dramatic">
        <h2>Responsive grid system</h2>
        {/* bg-warning: yellow / bg-primary: blue / bg-danger: red */}
        <div className="row">
      ...
      <div id="wd-css-responsive-forms-1">
        ...
        <div className="mb-3 row"> 
          ...
          <div className="col-sm-10"> 
          <textarea 
            className="form-control" id="textarea2" rows={3}>
          </textarea> 
          </div> 
        </div> 
      </div><br />
